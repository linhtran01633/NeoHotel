                                ...
                                <div class=" w-full rounded-2xl">
                                    @foreach ($faq as $item)
                                        ...
                                        <div class="mt-2 border border-solid mb-6 pt-2 pb-2" x-data="{showQuestion : false}">
                                            <button x-on:click.debounce.500ms="showQuestion = !showQuestion" class="flex w-full justify-between rounded-lg bg-white-100 px-4 py-2 text-left text-18px font-medium text-black focus:outline-none focus-visible:ring focus-text-633511" id="headlessui-disclosure-button-:r17:" type="button" aria-expanded="false" >
