                        ...
                        <div class=" justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
                            ...
                            <div class="flex pt-2">
                                <a rel="noopener noreferrer" href="https://www.facebook.com/profile.php?id=61555469886630" title="FACEBOOK" target="_blank" class="flex items-center justify-center w-10 h-10 rounded-full ">
                                    <svg stroke="currentColor" class="text-white" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="contact-wrapper col-span-full sm:row-span-2 sm:col-start-2 lg:col-span-2 lg:row-span-1">
                        ...
                        <div class="flex flex-col gap-5">
                            <div class="items-start flex gap-3">
                                <div class="w-16px">
                                    <svg class="text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true" width="20">
