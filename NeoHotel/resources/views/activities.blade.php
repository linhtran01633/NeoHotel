                        ...
                        <div class="w-full flex flex-col">
                            ...
                            <div class="w-full flex-col px-2 sm:px-0">
                                <div class="w-full flex space-x-1 bg-custom-dark p-1 mb-8" role="tablist" aria-orientation="horizontal">
                                    <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none" :class="buttonActiviti == 0  ? 'bg-white shadow' : 'text-white hover:bg-white/[0.12] hover:text-white'"  x-on:click.debounce.500ms="buttonActiviti = 0">
                                    ...
                                    <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none" :class="buttonActiviti == 1 ? 'bg-white shadow' : 'text-white hover:bg-white/[0.12] hover:text-white'"  x-on:click.debounce.500ms="buttonActiviti = 1">
                                        <div class="flex gap-1 sm:gap-4 items-center justify-center">
                                    ...
                                    <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none" :class="buttonActiviti == 2 ? 'bg-white shadow' : 'text-white hover:bg-white/[0.12] hover:text-white'"  x-on:click.debounce.500ms="buttonActiviti = 2">
                                        <div class="flex gap-1 sm:gap-4 items-center justify-center">
