                    ...
                    <div class="faq-container max-w-[1080px] m-auto flex flex-col sm:flex-row px-smClamp">
                        <div class="w-full flex flex-col">
                            <div class="mb-smClamp">
                                ...
                                <div class="w-12 h-0.5 bg-yellow-900 mt-2">
                                    </div>
                                </div>
                                <div class="w-full flex-col px-2 sm:px-0">
                                    <div class="w-full flex space-x-1 bg-[#222222] p-1 mb-8" role="tablist" aria-orientation="horizontal">
                                        <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none  bg-white shadow" id="headlessui-tabs-tab-:r0:" role="tab" type="button" aria-selected="true" tabindex="0" data-headlessui-state="selected" aria-controls="headlessui-tabs-panel-:r3:">
                                        ...
                                        <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none  text-white hover:bg-white/[0.12] hover:text-white" id="headlessui-tabs-tab-:r1:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r4:">
                                            <div class="flex gap-1 sm:gap-4 items-center justify-center">
                                        ...
                                        <button class="flex-1 w-full py-2.5 text-sm font-medium leading-5 ring-white/60 ring-offset-2  focus:outline-none  text-white hover:bg-white/[0.12] hover:text-white" id="headlessui-tabs-tab-:r2:" role="tab" type="button" aria-selected="false" tabindex="-1" data-headlessui-state="" aria-controls="headlessui-tabs-panel-:r5:">
                                            <div class="flex gap-1 sm:gap-4 items-center justify-center">
