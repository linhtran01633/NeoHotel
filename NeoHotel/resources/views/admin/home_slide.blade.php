...
@section('content')
    <div x-data='{
        ...
        <button type="button" x-on:click="openPopup" class="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-semibold text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
            Create Slide
        </button>
                        ...
                        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="w-full">
                                <div class="mt-3 sm:mt-0 sm:ml-4 text-left">
                                    <h3 class="text-lg leading-6 font-semibold text-gray-900" id="modal-title">Slide</h3>
            ...
            var table = $('#data_table').DataTable({
                ...
                columns: [
...

                    {
                        ...
                        render : function ( data, type, row ) {
                            let html =  `
                                <button type="button" x-on:click="editRow('${row.id}')" class="inline-flex items-center px-5 py-2.5 mx-1 text-sm font-semibold text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">
                                    EDIT
                                </button>
                                 <button type="button" x-on:click="editDelete('${row.id}')" class="inline-flex items-center px-5 py-2.5 mx-1 text-sm font-semibold text-center text-white rounded-lg bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300">
                                    Delete
                                </button>
                                `;
